...
async function main() {
  ...
  const triageIssues = [
    {
      number: 301,
      title: "Student portal crashes immediately during complaint submission",
      body: "After the latest portal update, the complaint form crashes on submit and sends students back to the dashboard.",
    ...
    },
    {
      ...
      body: "Refreshing the complaint routing rules applies some updates, but category shortcuts stop working until the dashboard is reopened.",
      source: IssueSource.DISCORD,
      status: IssueStatus.TRIAGE_PENDING,
      priority: Priority.HIGH,
    ...
    },
    {
      ...
      body: "Please allow department-wise complaint visibility rules instead of one global visibility setting for all complaint categories.",
      source: IssueSource.DISCORD,
      status: IssueStatus.TRIAGE_PENDING,
    ...
    {
      number: 307,
      title: "Complaint dashboard crashes when a second review panel is opened",
      body: "The reviewer workspace crashes when the second complaint review panel is opened side by side.",
      source: IssueSource.DISCORD,
      status: IssueStatus.TRIAGE_PENDING,
      priority: Priority.CRITICAL,
    ...
    },
    {
      ...
      body: "The complaint sync service becomes unresponsive after around 30 minutes. Records stop updating until the service is restarted.",
      source: IssueSource.DISCORD,
  ...
  const boardIssues = [
    {
      ...
      githubIssueUrl: "https://example.com/complaints/247",
      labels: [lBug.id, lHardware.id],
      assignee: alice.id,
      milestoneId: mv24.id,
      daysAgo: 14,
      prs: [
        { prNumber: 112, title: "fix: reviewer dashboard refresh regression", ciStatus: "failure", prUrl: "https://example.com/complaints/pr/112" },
      ],
    },
    {
      number: 251,
      title: "Add support for complaint workflow rule reload without restart",
      body: "Allow supervisors to reload complaint workflow rules without restarting the review dashboard.",
      source: IssueSource.GITHUB,
      status: IssueStatus.TODO,
      priority: Priority.MEDIUM,
      githubIssueNumber: 251,
      githubIssueUrl: "https://example.com/complaints/251",
      labels: [lEnhancement.id],
      assignee: bob.id,
      milestoneId: mv25.id,
      daysAgo: 21,
    ...
    },
    {
      ...
      githubIssueUrl: "https://example.com/complaints/255",
      labels: [lBug.id, lRegression.id, lWayland.id],
      assignee: carol.id,
      milestoneId: mv24.id,
      daysAgo: 8,
      prs: [
        { prNumber: 118, title: "fix: complaint table scaling on review screens", ciStatus: "success", prUrl: "https://example.com/complaints/pr/118" },
      ],
    },
    {
      number: 260,
      ...
      githubIssueUrl: "https://example.com/complaints/260",
    ...
    },
    {
      ...
      body: "The complaint update service drops connections after extended uptime. It needs reconnect handling and keepalive checks.",
      source: IssueSource.GITHUB,
      status: IssueStatus.IN_PROGRESS,
      priority: Priority.HIGH,
      githubIssueNumber: 263,
      githubIssueUrl: "https://example.com/complaints/263",
      labels: [lBug.id],
      assignee: dave.id,
      milestoneId: mv24.id,
      daysAgo: 5,
      prs: [
        { prNumber: 121, title: "fix: complaint sync keepalive", ciStatus: "pending", prUrl: "https://example.com/complaints/pr/121" },
      ],
    },
    {
      number: 264,
      ...
      githubIssueUrl: "https://example.com/complaints/264",
    ...
    },
    {
      ...
      githubIssueUrl: "https://example.com/complaints/268",
      labels: [lBug.id],
      assignee: alice.id,
      milestoneId: mv24.id,
      daysAgo: 12,
      prs: [
        { prNumber: 125, title: "fix: complaint card clipping", ciStatus: "success", prUrl: "https://example.com/complaints/pr/125" },
      ],
    },
    {
      number: 269,
      title: "Wayland crash on second monitor hotplug (HDMI)",
      body: "The complaint dashboard crashes when the secondary review screen is connected during active triage.",
      source: IssueSource.GITHUB,
      status: IssueStatus.TODO,
      priority: Priority.CRITICAL,
      githubIssueNumber: 269,
      githubIssueUrl: "https://example.com/complaints/269",
